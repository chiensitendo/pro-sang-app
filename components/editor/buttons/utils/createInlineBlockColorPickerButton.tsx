...
export default function createInlineBlockColorPickerButton({
                                                               prefix,
                                                               children,
                                                           }: CreateInlineStyleButtonProp): Props {
    return function InlineBlockColorPickerButton(props) {
        ...
        useEffect(() => {
            if (showColorPicker) {
                ...
                const twitterPicker = document.getElementsByClassName("twitter-picker-inline");
        ...
        useEffect(() => {
            if (props) {
                ...
                if (editorState) {
                    ...
                    if (color && btnRef && btnRef.current) {
        ...
        return (
            <div ref={addRef} className={clsx(theme.buttonWrapper, styles.wrapper)} onMouseDown={preventBubblingUp}>
                <button
                    ref={btnRef}
                    children={children}
                    {...buttonProps}
                    ...
                    role="button"
                />
                {showColorPicker && <div className={styles.picker}>
                    <TwitterPicker color={color ? color.hsl : undefined} colors={colors} className={"twitter-picker-inline"} onChange={submitColor}/>
                    <div className={styles.color_buttons}>
                        ...
                        <Button type="primary" onClick={() => setShowColorPicker(false)} danger
